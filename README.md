...
This repository currently pins the base image to `ghcr.io/berriai/litellm:v1.99.1`.
...
The current dictionaries target the UI bundled with LiteLLM `v1.99.1`. A newer
