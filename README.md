...
Each dictionary contains the same 5,060 source keys. `dict.json` remains the
...
This repository currently pins the base image to `ghcr.io/berriai/litellm:v1.98.0`.
...
The current dictionaries target the UI bundled with LiteLLM `v1.98.0`. A newer
